...
/**
 * Version file for skillsoft_customreportlog report
 *
...
$plugin->component = 'report_skillsoft_customreportlog'; // Full name of the plugin.
$plugin->maturity = MATURITY_STABLE; // Maturity of the plugin.
$plugin->release = '1.0.0'; // Release name of the plugin.
