...
$PAGE->set_url('/report/skillsoft_tdrreport/index.php', array('sort' => $sort, 'dir' => $dir, 'perpage' => $perpage,'filtervalue' => $filtervalue, 'filterby' => $filterby));
...
<div><label for="filtervalue_el"><?php print_string('skillsoft_tdrreport_filterlabel', 'report_skillsoft_tdrreport') ?></label>
<input type="text" name="filtervalue" id="filtervalue_el"
	value="<?php echo $filtervalue ?>" /> <?php $options = array(	'tdrid' => get_string('skillsoft_tdrreport_tdrid', 'report_skillsoft_tdrreport'),
	...
	?> <input type="submit"
	value="<?php print_string('skillsoft_tdrreport_applyfilter', 'report_skillsoft_tdrreport')?>" />
</div>
</form>
</div>
		...
		if ($filtervalue == '') {
			...
			switch ($filterby) {
				...
				case "assetid":
					...
					break;
				case "username":
					$where = 'WHERE tdr.username = "'.$filtervalue.'" ';
					break;
			}
		}
